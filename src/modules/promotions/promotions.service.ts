...
export class PromotionsService {
  ...
  async create(
    ...
    try {
      ...
      this.logger.error(
        errPromotionMessage.ERROR_CREATE_PROMOTION,
        error.stack,
      );
  ...
  async findAll(status?: string, branchId?: string): Promise<PromotionResponse> {
    try {
      ...
      this.logger.error(errPromotionMessage.ERROR_FIND_PROMOTION, error.stack);
      throw new InternalServerErrorException(
        errPromotionMessage.ERROR_FIND_PROMOTION,
      );
    }
  }
  ...
  async update(
    ...
    try {
      ...
      if (
        ...
        throw error;
      this.logger.error(
        errPromotionMessage.ERROR_UPDATE_PROMOTION,
        error.stack,
      );
      throw new InternalServerErrorException(
        errPromotionMessage.ERROR_UPDATE_PROMOTION,
  ...
  async remove(
    ...
    try {
      ...
      this.logger.error(
        errPromotionMessage.ERROR_DELETE_PROMOTION,
        error.stack,
      );
      throw new InternalServerErrorException(
        errPromotionMessage.ERROR_DELETE_PROMOTION,
