export const successProductStockMessage = {
  SUCCESS_CREATE_PRODUCT_STOCK: 'Product stock created successfully',
  SUCCESS_UPDATE_PRODUCT_STOCK: 'Product stock updated successfully',
